...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC4     ------> ADC1_IN14
    */
    HAL_GPIO_DeInit(Sensor_Pressure_ADC_Input_GPIO_Port, Sensor_Pressure_ADC_Input_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA1     ------> ADC2_IN1
    */
    HAL_GPIO_DeInit(V12_ADC_Input_GPIO_Port, V12_ADC_Input_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA0-WKUP     ------> ADC3_IN0
    */
    HAL_GPIO_DeInit(GPIOC, Curr_Sensor_ServoDC_ADC_Input_Pin|Curr_Sensor_Clamp_ADC_Input_Pin);

    HAL_GPIO_DeInit(Curr_Sensor_Spindle_ADC_Input_GPIO_Port, Curr_Sensor_Spindle_ADC_Input_Pin);
